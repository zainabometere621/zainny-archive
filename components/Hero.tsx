      ...
      <div className="flex flex-col items-center justify-center space-y-6 bg-[#f2d4d7] py-16">
        ...
        <div className="flex gap-14 items-center">
          <div className="flex flex-col space-y-1 items-center">
            <h2 className="text-2xl lg:text-4xl text-[#6b1f3a]">16</h2>
            <p className="uppercase text-xs lg:text-lg tracking-wider text-[#9b4e68]">looks</p>
          </div>
          <div className="flex flex-col space-y-1 items-center">
            <h2 className="text-2xl lg:text-4xl text-[#6b1f3a]">8</h2>
            <p className="uppercase text-xs lg:text-lg tracking-wider text-[#9b4e68]">categories</p>
          </div>
          <div className="flex flex-col space-y-1 items-center">
           <h2 className="text-3xl lg:text-4xl text-[#6B1F3A]">∞</h2>
            <p className="uppercase text-xs lg:text-lg tracking-wider text-[#9b4e68]">inspiration</p>
          </div>
        </div>
      </div>
    </section>
